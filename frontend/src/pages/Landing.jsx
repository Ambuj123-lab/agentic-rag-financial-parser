        ...
        <div style={{ maxWidth: 1040, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            {[
              ...
              { icon: FiTrendingUp, name: 'Tool Calling (Live APIs)', desc: 'Autonomously executes external Python tools (RapidAPI Yahoo Finance) to fetch real-time market data, bypassing standard vector retrieval.', color: 'var(--green)' },
