        ...
        <div style={{ maxWidth: 1040, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            {[
              ...
              { icon: FiTrendingUp, name: 'Tool Calling (Live Stocks)', desc: 'Autonomously executes external Python tools (RapidAPI Yahoo Finance) to fetch live stock prices and real-time market data, bypassing standard vector retrieval.', color: 'var(--green)' },
