              ...
              <tr>
                <td style="background: linear-gradient(135deg, #0f172a, #1e293b); padding: 25px 30px; text-align: center;">
                  ...
                  <p style="color: #94a3b8; font-size: 11px; margin: 0; line-height: 1.6;">
                    Generated by <strong style="color: #a5b4fc;">Adaptive ReAct Agentic RAG</strong> &bull; Sources verified via <strong style="color: #a5b4fc;">Tavily</strong> &bull; Powered by <strong style="color: #a5b4fc;">LangGraph + Gemini</strong>
                  </p>
                  ...
                  <p style="color: #94a3b8; font-size: 11px; margin: 8px 0 0 0; font-weight: 500;">📍 Gorakhpur, India</p>
                </td>
              </tr>
