...
- **CRITICAL RULES:**
  - NEVER show your reasoning process in the response.
  - NEVER show bullet points of your thinking steps.
  - NEVER show source evaluation steps.
  - Output ONLY the final formatted answer directly.
  - Do NOT write "User Question:", "Context provided:", or any meta-analysis.
- **NO INTERNAL LOGS:** NEVER output headers like "Thinking", or "Context Provided". Keep your internal steps in your thought process only.
- **FINAL ANSWER ONLY:** Only output the final polished response meant for the user. 
- **NO HALLUCINATED FOOTERS:** Do not generate your own footers or attribution lines (e.g., "Generated by..."). Only use the formatting rules below.
